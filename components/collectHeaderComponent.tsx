...
export default function CollectHeaderComponent({isOpened, onMouseEnter, onMouseLeave}:propsType):React.ReactNode {
    // Returning JSX
    return (
        <div data-opened={isOpened} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} className={'border-t transition-all duration-500 border-t-myYellow shadow-lg h-[50vh] overflow-auto lg:block hidden data-[opened="true"]:visible data-[opened="true"]:opacity-100 data-[opened="false"]:invisible data-[opened="false"]:h-[0] data-[opened="false"]:opacity-0'}>
            <div className={'flex gap-[20px] p-[20px]'}>
                ...
                <Image className={'w-[25%] object-cover'} src={AqsatiImage.src} alt={'خرید اقساطی'} width={100} height={100} />
            </div>
